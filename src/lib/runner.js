...
class Runner {
  ...
  runCommand(binPath, args, options = { onStdOut: null }) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const executable = isDeno ? globalThis.Deno.execPath() : process.execPath;
